  ...
  return (
    <>
      <style>{`
        ...
        .input-wrapper.focused::after { transform: scaleX(1); }
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-3 items-stretch sm:items-center">
              <Link href="/auth" passHref>
                <button
                  ...
                  className={`cta-btn flex items-center justify-center gap-3 px-8 py-4 rounded-lg font-bold text-base md:text-lg uppercase tracking-wide cursor-pointer whitespace-nowrap transition-all duration-200 disabled:cursor-not-allowed disabled:opacity-70 ${
                    isLoading
                      ? "bg-[#E50914]/80"
                      : submitted
